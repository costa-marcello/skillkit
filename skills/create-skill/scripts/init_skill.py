...
def init_skill(skill_name, path):
    ...
    try:
        ...
        print("   Recovery: Check that the parent directory exists and you have write permissions.")
        return None
    ...
    try:
        ...
        print("   Recovery: Check disk space and file permissions on the skill directory.")
        return None
    ...
    try:
        ...
        print("   Recovery: Check disk space, file permissions, or if the directory was partially created.")
        return None
