...
## Review Effectiveness Thresholds

Research from SmartBear (analysis of 8 million PRs) establishes clear thresholds for effective code review:

- **Optimal diff size**: 200-400 lines. Effectiveness drops sharply beyond 400 lines.
- **Optimal review time**: 60 minutes per session. Defect detection declines after this point.
- **Defect catch rate**: Code review catches 55-60% of defects, outperforming unit testing (25%), function testing (35%), and integration testing (45%).
- **Key implication**: if reviewing a large diff, batch by module and take breaks between batches.
