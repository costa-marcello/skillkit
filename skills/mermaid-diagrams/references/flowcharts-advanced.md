...
Styling, comprehensive examples, and common patterns for flowcharts.

## Styling

<example name="Individual Styling">
...
<example name="E-Commerce Checkout">
...
<example name="Branching Decision">
