...
<example name="Participants and Actors">
...
<example name="Synchronous Messages">
...
<example name="Asynchronous Messages">
...
<example name="API Request/Response">
